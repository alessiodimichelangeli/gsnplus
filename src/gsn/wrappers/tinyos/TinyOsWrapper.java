/*
* File: src/gsn/wrappers/tinyos/TinyOsWrapper.java
*
...
//THIS WRAPPER IS A SIMPLE TINY OS WRAPPER.
//It reads datas from the TelosbSensorReadingMsg(it can be changed), and sends them to the gsn server.
//After, it's possible to catch this data via xml.
...
public class TinyOsWrapper extends AbstractWrapper implements net.tinyos.message.MessageListener {
	...
	*/
	...
	//YOU HAVE TO EDIT THIS
  	private String packetName="TelosbSensorReadingNoMessageEditsMsg"; //this is the name of the file generated by mig 
  	//
  	
  	private String path="/home/alessio/gsnplus/src/gsn/wrappers/tinyos/"; //this is the path of the file generated by mig
	...
	private final transient Logger logger = Logger.getLogger( TinyOsWrapper.class );
	...
	public boolean initialize ( ) {
		...
		setName( "TinyOsWrapper"+ ( ++threadCounter ) ) ;
